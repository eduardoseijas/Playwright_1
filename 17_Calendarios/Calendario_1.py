...
#creando nuestro Objeto de tipo Funciones_Globales
    ...
    #Calendario
    F.Texto("//input[@id='dateFormat']","2025-08-23",2) #tuve que escribirlo de año mes y dia con - en vez de /
    
    #Para hacer click en otra area y perder el foco seleccionado
    #page.mouse.click(0,50) #Esta es una funcion, esta pide coordenadas x,y
    
    
    #Con la funcion creada
    F.Mouse_X_Y(0,50,2)
